...
Missing **age_group** are filled, but we didn’t fill the missing data
for the column **EOP size** and **FHP size**.

**In these two *“size”* coloumns, most of the rows with a missing
*“size”* value have a corresponding *‘category’* value also as 0.** It’s
unclear whether such a participate is in the number 0 category or that 0
just means “N/A”. We should just exclude those rows from the analysis.
