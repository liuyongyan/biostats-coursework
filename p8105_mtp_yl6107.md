...
We didn’t fill the missing data in **eop_mm** and **fhp_mm** column even
if we can *guess* a value from the corresponding category. If we do so,
a lot of statistics, like the mean size, will be polluted.
